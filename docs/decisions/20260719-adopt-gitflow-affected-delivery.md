...
owner-only dispatch; после него главный агент выполняет exact-head squash через
GitHub branch protection, сохраняя обычные delivery/cleanup events. Ручной
merge принятие не обходит. Non-runtime Dev/release
