...
Справочник содержит точные карты, команды и каталоги. Он отвечает на вопрос
«какие элементы существуют и как они называются», но не является заменой
нормативным спецификациям.
