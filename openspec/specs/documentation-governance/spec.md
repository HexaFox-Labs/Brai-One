...
Defines the project-wide documentation governance lane that evaluates ADR
impact, backfills missing Change evidence, and remains callable outside Codex
through repository rules and deterministic checks.
